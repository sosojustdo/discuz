...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1431565766, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1431565766, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1431565766, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
;?>
...
-->
    <div class="hdc cl"><?php $mnid = getcurrentnav();?><h2><a href="./" title="Discuz! Board"><img src="data/images/logo.jpg" alt="Discuz! Board" border="0"></a></h2><?php include template('common/header_userstatus'); ?></div>
...
<div id="scbar" class="<?php if($_G['setting']['srchhotkeywords'] && count($_G['setting']['srchhotkeywords']) > 5) { ?>scbar_narrow <?php } ?>cl">
    <div class="scbar_cl cl">
        <div id="pt" class="bm cl">
            <div class="y">
                <script type="text/javascript">announcement();</script>
            </div>
            <div class="z">
                <a href="./" class="nvhm" title="首页">Discuz! Board</a><em>»</em><a href="forum.php">论坛</a></div>
            <div class="z"></div>
        </div>
