...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1429067420, '1', './data/template/1_1_member_login.tpl.php', './template/default', 'member/login')
...
<?php if(!empty($_G['setting']['pluginhooks']['logging_side_top'])) echo $_G['setting']['pluginhooks']['logging_side_top'];?>
    <a href="https://login.dangdang.com/register.php" target="_blank" class="xi2">没有帐号？<a href="https://login.dangdang.com/register.php" target="_blank"><?php echo $_G['setting']['reglinkname'];?></a></a>
</span>
...
<td class="tipcol"><a href="https://login.dangdang.com/register.php" target="_blank">立即注册</a></td>
</tr>
</table>
</div>
<div class="rfm">
...
<td class="tipcol"><a href="javascript:;" onclick="display('layer_login_<?php echo $loginhash;?>');display('layer_lostpw_<?php echo $loginhash;?>');" title="找回密码">找回密码</a></td>-->
    <td class="tipcol"><a href="javascript:;" onclick="showWindow('login', 'member.php?mod=logging&action=login&viewlostpw=1')" title="找回密码">找回密码</a></td>
</tr>
</table>
</div>
