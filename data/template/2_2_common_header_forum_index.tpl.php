...
0
|| checktplrefresh('./template/mobanbus_masonryv1/common/header.htm', './template/mobanbus_masonryv1/common/header_common.htm', 1431405053, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/mobanbus_masonryv1', 'common/header_forum_index')
|| checktplrefresh('./template/mobanbus_masonryv1/common/header.htm', './template/mobanbus_masonryv1/common/pubsearchform.htm', 1431405053, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/mobanbus_masonryv1', 'common/header_forum_index')
|| checktplrefresh('./template/mobanbus_masonryv1/common/header.htm', './template/default/common/header_qmenu.htm', 1431405053, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/mobanbus_masonryv1', 'common/header_forum_index')
;?>
<!doctype html>
...
<?php } ?>
<script src="template/mobanbus_masonryv1/mobanbus_st/js/mobanbus_pace.js" type="text/javascript"></script>
<script src="template/mobanbus_masonryv1/mobanbus_st/js/jQuery.js" type="text/javascript"></script>
<script src="template/mobanbus_masonryv1/mobanbus_st/js/mobanbusjs.js" type="text/javascript"></script>
...
<?php } ?>
<div class="bus_hads"><?php echo adshow("headerbanner/wp");?></div>

<div class="bus_header bus_relative">
<div id="box">
<div id="bus_nv">
<div class="bus_w98"><?php $mnid = getcurrentnav();?><div class="bus_logo bus_fl"><h1><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h1></div>
<ul class="bus_box animated fadeInUp"><?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><li <?php if($mnid == $nav['navid']) { ?>class="select" <?php } ?><?php echo $nav['nav'];?>></li><?php } } ?>
</ul>
...
<?php } } ?>
<li><a href="home.php?mod=spacecp&ac=credit">设置</a></li>
...
<div class="bus_push"><a href="forum.php?mod=misc&amp;action=nav" onClick="showWindow('nav', this.href, 'get', 0)" class="bus_push_addnew">发布</a></div>
...
<tr>            
<td class="scbar_txt_td bus_hide"><input type="text" name="srchtxt" id="scbar_txt" value="请输入搜索内容" autocomplete="off" x-webkit-speech speech /></td>
...
<div class="clear"></div>
<?php if($_G['basescript'] == 'portal' && CURMODULE == 'index') { } else { ?><div class="mobanbus"><?php } ?>
