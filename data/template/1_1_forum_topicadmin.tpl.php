...
<h3 class="flb">
<em id="return_mods">!admin_select_piece!</em>
<span>
<a href="javascript:;" class="flbc" onclick="hideWindow('mods')" title="!close!">!close!</a>
</span>
</h3>
...
<td class="hasd">
<label onclick="switchitemcp('itemcp_stick')" class="labeltxt">!thread_stick!</label>
<div class="dopt">
...
<option value="1" <?php echo $stickcheck['1'];?>>!yes!&nbsp;</option>
<?php } ?>
</select>
</div>
</td>
...
<td class="hasd">
<label onclick="switchitemcp('itemcp_digest')" class="labeltxt">!admin_digest_add!</label>
<div class="dopt">
<select name="digestlevel">
<option value="0">!admin_digest_remove!</option>
<option value="1" <?php echo $digestcheck['1'];?>>!thread_digest! 1</option>
<?php if($_G['group']['allowdigestthread'] >= 2) { ?>
<option value="2" <?php echo $digestcheck['2'];?>>!thread_digest! 2</option>
<?php if($_G['group']['allowdigestthread'] == 3) { ?>
<option value="3" <?php echo $digestcheck['3'];?>>!thread_digest! 3</option>
<?php } } ?>
</select>
</div>
</td>
...
<td class="hasd">
<label onclick="switchitemcp('itemcp_bump')" class="labeltxt">!bump!</label>
</td>
</tr>
<tr class="dopt">
<td>&nbsp;</td>
<td>
<p class="hasd">
<label for="expirationbump" class="labeltxt">!expire!</label>
...
<td class="hasd"><?php $_G['forum_colorarray'] = array(1=>'#EE1B2E', 2=>'#EE5023', 3=>'#996600', 4=>'#3C9D40', 5=>'#2897C5', 6=>'#2B65B7', 7=>'#8F2A90', 8=>'#EC1282');?><label onclick="switchitemcp('itemcp_highlight')" class="labeltxt">!thread_highlight!</label>
<div class="dopt">
<span class="hasd">
...
<a href="javascript:;" id="highlight_op_1" onclick="switchhl(this, 1)" class="dopt_b<?php if($stylecheck['1']) { ?> cnt<?php } ?>" style="text-indent:0;text-decoration:none;font-weight:700;" title="!e_bold!">B</a>
<a href="javascript:;" id="highlight_op_2" onclick="switchhl(this, 2)" class="dopt_i<?php if($stylecheck['2']) { ?> cnt<?php } ?>" style="text-indent:0;text-decoration:none;font-style:italic;" title="!e_italic!">I</a>
<a href="javascript:;" id="highlight_op_3" onclick="switchhl(this, 3)" class="dopt_l<?php if($stylecheck['3']) { ?> cnt<?php } ?>" style="text-indent:0;text-decoration:underline;" title="!e_underline!">U</a>
</div>
</td>
</tr>
<tr class="dopt">
...
<td>
<p class="hasd">
<label for="expirationhighlight" class="labeltxt">!expire!</label>
...
<td>
<p class="hasd">
<label class="labeltxt">!backgroundcolor!:</label>
...
<td>
<label onclick="switchitemcp('itemcp_recommend')" class="labeltxt">!recommend!</label>
<div class="dopt">
<label class="lb"><input type="radio" name="isrecommend" class="pr" value="1" checked="checked" />!recommend!</label>
<label><input type="radio" name="isrecommend" class="pr" value="0" />!admin_unrecommend!</label>
</div>
</td>
</tr>
<tr class="dopt">
...
<td>
<p class="hasd">
<label for="expirationrecommend" class="labeltxt">!expire!</label>
...
<td>&nbsp;</td>
<td>
<label for="reducetitle" class="labeltxt">!forum_recommend_reducetitle!</label>
...
<td>&nbsp;</td>
<td>
<label class="labeltxt">!forum_recommend_image!</label>
<select name="selectattach" onchange="updateimginfo(this.value)" class="ps" style="width: 132px">
<option value="">!forum_recommend_noimage!</option><?php if(is_array($imgattach)) foreach($imgattach as $imginfo) { ?><option value="<?php echo $imginfo['aid'];?>"<?php if($selectattach == $imginfo['aid']) { ?> selected="selected"<?php } ?>><?php echo $imginfo['filename'];?></option>
<?php } ?>
</select>
</td>
</tr>
...
<p class="mbn tahfx">
!admin_target!: <select name="moveto" id="moveto" class="ps vm" onchange="ajaxget('forum.php?mod=ajax&action=getthreadtypes&fid=' + this.value, 'threadtypes');if(this.value) {$('moveext').style.display='';} else {$('moveext').style.display='none';}">
...
<li class="wide"><label><input type="radio" name="type" class="pr" value="normal" checked="checked" />!admin_move!</label></li>
<li class="wide"><label><input type="radio" name="type" class="pr" value="redirect" />!admin_move_hold!</label></li>
</ul>
<?php } else { if($typeselect) { ?>
<input type="hidden" name="operations[]" value="type" />
<p>!types!: <?php echo $typeselect;?></p>
<?php } else { ?>
!admin_type_msg!<?php $hiddensubmit = true;?><?php } } ?>
</div>
...
<p>!admin_delthread_confirm!</p>
<?php } else { ?>
<p>!admin_delthread_nopermission!</p>
<?php } ?>
</li>
...
<td class="hasd"><label onclick="switchitemcp('itemcp_bump');" class="labeltxt" style="width:50px;margin:5px 0 10px 0px;">!admin_bump!</label></td>
</tr>
<tr class="dopt">
<td>&nbsp;</td>
<td>
...
<td class="hasd"><label onclick="switchitemcp('itemcp_down');" class="labeltxt" style="width:50px;margin:5px 0 10px 0px;">!admin_down!</label></td>
</tr>
<!--
<tr class="dopt">
<td>&nbsp;</td>
<td>
<p class="hasd">
<label for="expirationdown" class="labeltxt">!expire!</label>
...
<ul class="llst">
<li class="wide"><label><input type="radio" name="operations[]" class="pr" value="open" <?php echo $closecheck['0'];?>  onclick="$('expirationclose').value='';" />!admin_open!</label></li>
<li class="wide"><label><input type="radio" name="operations[]" class="pr" value="close" <?php echo $closecheck['1'];?> />!admin_close!</label></li>
</ul>
</td>
</tr>
</table>
...
<p class="mbn tahfx">
!admin_target!: <select id="moveto" name="moveto" class="ps vm">
<?php echo $forumselect;?>
</select>
</p>
<?php } ?>
...
<h4 class="cl"><a onclick="showselect(this, 'reason', 'reasonselect')" class="dpbtn" href="javascript:;">^</a><span>!admin_reason!:</span></h4>
<p>
...
<button type="submit" name="modsubmit" id="modsubmit" class="pn pnc" value="!confirms!"><span>!confirms!</span></button>
</p>
<?php } ?>
</form>
</div>
