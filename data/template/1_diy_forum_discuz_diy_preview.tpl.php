<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz_diy_preview');
block_get('8,9,10');?><?php include template('common/header'); ?><div id="pt" class="bm cl">
...
<style id="diy_style" type="text/css">#frameQOT2Lu { border:#cccccc 1px solid !important;margin-bottom:10px !important;}#framezczRg4 { border-top:#cccccc 1px solid !important;border-right:#cccccc 0px solid !important;border-bottom:#cccccc 0px solid !important;border-left:#cccccc 0px solid !important;}#frame1xGi7L { border-top:#cccccc 1px solid !important;border-right:#cccccc 0px solid !important;border-bottom:#cccccc 0px solid !important;border-left:#cccccc 0px solid !important;}</style>
...
<p class="chart z">今日: <em><?php echo $todayposts;?></em><span class="pipe">|</span>昨日: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>帖子: <em><?php echo $posts;?></em><span class="pipe">|</span>会员: <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['cache']['userstats']['newsetuser']) { } ?></p>
<div class="y">
...
<div class="wp mtn">
<!--[diy=diy3]--><div id="diy3" class="area"><div id="frameQOT2Lu" class=" frame move-span cl frame-1"><div class="title frame-title" style='background-repeat:repeat;'><span class="titletext"><a href="forum.php?mod=forumdisplay&amp;fid=52" target="_blank" style="color:rgb(0, 0, 0) !important;">当当读书热门帖</a></span></div><div id="frameQOT2Lu_left" class="column frame-1-c"><div id="frameQOT2Lu_left_temp" class="move-span temp"></div><?php block_display('8');?><div id="frame1xGi7L" class=" frame move-span cl frame-1"><div class="title frame-title"><span class="titletext"><a href="forum.php?mod=forumdisplay&amp;fid=53" target="_blank" style="color: !important;">当读小说热门帖</a></span></div><div id="frame1xGi7L_left" class="column frame-1-c"><div id="frame1xGi7L_left_temp" class="move-span temp"></div><?php block_display('9');?></div></div><div id="framezczRg4" class=" frame move-span cl frame-1"><div class="title frame-title"><span class="titletext"><a href="forum.php?mod=forumdisplay&amp;fid=54" target="_blank" style="color: !important;">翻篇儿热门帖</a></span></div><div id="framezczRg4_left" class="column frame-1-c"><div id="framezczRg4_left_temp" class="move-span temp"></div><?php block_display('10');?></div></div></div></div></div><!--[/diy]-->
</div>
